...
@keyframes wing_float {
  0%, 100% { transform: translateY(0px) rotate(-8deg) scaleX(-1); }
  50% { transform: translateY(-6px) rotate(-12deg) scaleX(-1); }
}
@keyframes wing_float_r {
  0%, 100% { transform: translateY(0px) rotate(8deg); }
  50% { transform: translateY(-6px) rotate(12deg); }
}
@keyframes golden_ribbon {
  0% { transform: translateX(-110%) rotate(-30deg); }
  100% { transform: translateX(210%) rotate(-30deg); }
}
@keyframes inferno_pulse {
  0%, 100% { background-position: 0% 50%; }
  50% { background-position: 100% 50%; }
}
@keyframes crumble_shake {
  0%, 100% { transform: rotate(0deg); }
  25% { transform: rotate(-1deg) translateX(-1px); }
  75% { transform: rotate(1deg) translateX(1px); }
}
@keyframes neon_flicker {
  0%, 100% { box-shadow: 0 0 8px rgba(0,245,255,0.6), 0 0 20px rgba(0,245,255,0.3); }
  50% { box-shadow: 0 0 16px rgba(0,245,255,1), 0 0 40px rgba(0,245,255,0.6), 0 0 60px rgba(0,245,255,0.2); }
}
@keyframes baroque_shimmer {
  0% { background-position: 0% 50%; }
...
@keyframes lava_glow {
  0%, 100% { box-shadow: 0 0 30px rgba(255,50,0,0.6), 0 0 60px rgba(200,0,0,0.3); }
  50% { box-shadow: 0 0 50px rgba(255,100,0,0.9), 0 0 100px rgba(255,50,0,0.5); }
}
</style>
"""
...
def render_card_html(a, size="normal", clickable=True):
    ...
    if tier == "bronzo_comune":
        ...
        overlay = f'<div style="position:absolute;top:0;left:-120%;width:60%;height:100%;background:linear-gradient(105deg,transparent,rgba(255,160,60,0.25),transparent);border-radius:14px;animation:shine_swipe 3.5s ease-in-out infinite;pointer-events:none"></div>'
        card_extra_style = ""
        card_shape = "border-radius:14px;"
        ...
        overlay = f'<div style="position:absolute;top:0;left:-120%;width:60%;height:100%;background:linear-gradient(105deg,transparent,rgba(150,200,255,0.3),transparent);border-radius:14px;animation:shine_swipe 2.8s ease-in-out infinite;pointer-events:none"></div>'
        card_extra_style = ""
        card_shape = "border-radius:14px;"
        ...
        overlay = f'<div style="position:absolute;top:0;left:-120%;width:55%;height:100%;background:linear-gradient(105deg,transparent,rgba(255,215,0,0.4),rgba(255,180,0,0.2),transparent);border-radius:14px;animation:shine_swipe 2.2s ease-in-out infinite;pointer-events:none"></div><div style="position:absolute;top:0;left:0;right:0;height:3px;background:linear-gradient(90deg,transparent,#FFD700,#FFA500,#FFD700,transparent);border-radius:14px 14px 0 0;pointer-events:none"></div>'
        card_extra_style = ""
        card_shape = "border-radius:14px;"
        ...
        <div style="position:absolute;top:0;left:0;right:0;bottom:0;pointer-events:none;border-radius:14px;overflow:hidden">
          <div style="position:absolute;top:0;left:-120%;width:55%;height:100%;background:linear-gradient(105deg,transparent,rgba(200,0,255,0.35),transparent);animation:shine_swipe 2.5s ease-in-out infinite"></div>
          <div style="position:absolute;top:8px;left:50%;transform:translateX(-50%);color:rgba(220,100,255,0.6);font-size:0.5rem;letter-spacing:4px">⚡ ⚡ ⚡ ⚡ ⚡</div>
        </div>
        <div style="position:absolute;top:15%;left:-18px;font-size:2.2rem;color:#CC00FF;opacity:0.7;animation:wing_float 3s ease-in-out infinite;pointer-events:none;filter:drop-shadow(0 0 6px #CC00FF)">⚡</div>
        <div style="position:absolute;top:15%;right:-18px;font-size:2.2rem;color:#CC00FF;opacity:0.7;animation:wing_float_r 3s ease-in-out infinite 0.4s;pointer-events:none;filter:drop-shadow(0 0 6px #CC00FF)">⚡</div>
        ...
        <div style="position:absolute;top:-6px;left:10%;right:10%;height:5px;background:linear-gradient(90deg,transparent,#FFD700,transparent);border-radius:99px;animation:shine_swipe 3s linear infinite;pointer-events:none;overflow:hidden"></div>
        <div style="position:absolute;top:-6px;left:10%;right:10%;height:5px;overflow:hidden;border-radius:99px;pointer-events:none">
          <div style="width:40%;height:100%;background:linear-gradient(90deg,transparent,rgba(255,215,0,0.9),transparent);animation:golden_ribbon 2.5s linear infinite"></div>
        </div>
        '''
        card_extra_style = ""
        card_shape = "border-radius:14px;"
        ...
        <div style="position:absolute;top:0;left:0;right:0;bottom:0;pointer-events:none;border-radius:16px;overflow:hidden">
          <div style="position:absolute;top:0;left:-120%;width:50%;height:100%;background:linear-gradient(105deg,transparent,rgba(255,255,255,0.45),rgba(255,215,0,0.3),transparent);animation:shine_swipe 1.8s ease-in-out infinite"></div>
        </div>
        <div style="position:absolute;top:-14px;left:50%;transform:translateX(-50%);font-size:1.8rem;filter:drop-shadow(0 0 8px gold)">⭐</div>
        ...
        <div style="position:absolute;top:0;left:0;right:0;bottom:0;pointer-events:none;overflow:hidden;border-radius:16px">
          <div style="position:absolute;top:0;left:-120%;width:50%;height:100%;background:linear-gradient(105deg,transparent,rgba(255,255,255,0.6),transparent);animation:shine_swipe 2s ease-in-out infinite"></div>
        </div>
        <!-- Ali da angelo sinistra -->
        <div style="position:absolute;top:18%;left:-32px;width:40px;height:80px;pointer-events:none;overflow:visible">
          <svg width="40" height="80" viewBox="0 0 40 80" style="animation:wing_float 4s ease-in-out infinite;filter:drop-shadow(0 0 6px rgba(255,255,255,0.8))">
        ...
        <!-- Ali da angelo destra -->
        <div style="position:absolute;top:18%;right:-32px;width:40px;height:80px;pointer-events:none;overflow:visible">
          <svg width="40" height="80" viewBox="0 0 40 80" style="animation:wing_float_r 4s ease-in-out infinite 0.3s;filter:drop-shadow(0 0 6px rgba(255,255,255,0.8))">
        ...
        <!-- Fulmini -->
        <div style="position:absolute;top:30%;left:8px;width:4px;height:30px;background:linear-gradient(180deg,rgba(255,215,0,0.9),transparent);border-radius:2px;animation:lightning 4s ease-in-out infinite;pointer-events:none"></div>
        <div style="position:absolute;top:25%;right:8px;width:3px;height:25px;background:linear-gradient(180deg,rgba(255,215,0,0.8),transparent);border-radius:2px;animation:lightning2 4s ease-in-out infinite 1.5s;pointer-events:none"></div>
        ...
        overlay = f'''
        <!-- Ali argentate pseudo-element simulation -->
        <div style="position:absolute;top:12%;left:-40px;width:48px;height:90px;pointer-events:none">
          <svg width="48" height="90" viewBox="0 0 48 90" style="animation:wing_float 3.5s ease-in-out infinite;filter:drop-shadow(0 0 10px rgba(200,220,255,0.9))">
        ...
        <div style="position:absolute;top:12%;right:-40px;width:48px;height:90px;pointer-events:none">
          <svg width="48" height="90" viewBox="0 0 48 90" style="animation:wing_float_r 3.5s ease-in-out infinite 0.4s;filter:drop-shadow(0 0 10px rgba(200,220,255,0.9))">
        ...
        <!-- Nubi scintillanti -->
        <div style="position:absolute;top:4px;left:5px;font-size:1rem;opacity:0.5;animation:cloud_drift 4s ease-in-out infinite;pointer-events:none">☁️</div>
        <div style="position:absolute;top:4px;right:5px;font-size:0.85rem;opacity:0.4;animation:cloud_drift 4s ease-in-out infinite 1.5s;pointer-events:none">☁️</div>
        <!-- Fulmini animati -->
        <div style="position:absolute;top:20%;left:5px;font-size:0.8rem;animation:lightning 3.5s infinite;pointer-events:none;color:#FFD700">⚡</div>
        <div style="position:absolute;top:35%;right:5px;font-size:0.7rem;animation:lightning2 3.5s infinite 1.2s;pointer-events:none;color:#A0C0FF">⚡</div>
        <!-- Shine swipe -->
        <div style="position:absolute;top:0;left:0;right:0;bottom:0;pointer-events:none;overflow:hidden;border-radius:18px">
          <div style="position:absolute;top:0;left:-120%;width:50%;height:100%;background:linear-gradient(105deg,transparent,rgba(255,215,0,0.2),rgba(200,220,255,0.15),transparent);animation:shine_swipe 2s ease-in-out infinite"></div>
        </div>
        ...
        label_txt = "👑 TOTY+"; ovr_col = "#FFD700"
        overlay = f'''
        <!-- Ali dorate con filtri CSS -->
        <div style="position:absolute;top:10%;left:-44px;width:52px;height:95px;pointer-events:none">
          <svg width="52" height="95" viewBox="0 0 52 95" style="animation:wing_float 3s ease-in-out infinite;filter:drop-shadow(0 0 12px rgba(255,215,0,0.9)) sepia(0.4) hue-rotate(10deg)">
        ...
        <div style="position:absolute;top:10%;right:-44px;width:52px;height:95px;pointer-events:none">
          <svg width="52" height="95" viewBox="0 0 52 95" style="animation:wing_float_r 3s ease-in-out infinite 0.5s;filter:drop-shadow(0 0 12px rgba(255,215,0,0.9)) sepia(0.4) hue-rotate(10deg)">
            <path d="M0,8 Q52,20 50,47 Q52,74 0,86 Q28,66 26,47 Q28,28 0,8Z" fill="rgba(255,215,0,0.75)" stroke="#FFD700" stroke-width="1.2"/>
          </svg>
        </div>
        <!-- Torri doriche simboliche -->
        <div style="position:absolute;bottom:-5px;left:-8px;font-size:1.8rem;opacity:0.4;pointer-events:none;filter:sepia(1) hue-rotate(-10deg)">🏛️</div>
        <div style="position:absolute;bottom:-5px;right:-8px;font-size:1.8rem;opacity:0.4;pointer-events:none;filter:sepia(1) hue-rotate(-10deg) scaleX(-1)">🏛️</div>
        <!-- Nubi grigie con fulmini -->
        <div style="position:absolute;top:5px;left:8px;font-size:0.9rem;opacity:0.45;animation:cloud_drift 5s ease-in-out infinite;pointer-events:none;filter:grayscale(0.5)">⛈️</div>
        <div style="position:absolute;top:5px;right:8px;font-size:0.85rem;opacity:0.35;animation:cloud_drift 5s ease-in-out infinite 2s;pointer-events:none;filter:grayscale(0.5)">⛈️</div>
        <!-- Shine viola + oro -->
        <div style="position:absolute;top:0;left:0;right:0;bottom:0;pointer-events:none;overflow:hidden">
          <div style="position:absolute;top:0;left:-120%;width:50%;height:100%;background:linear-gradient(105deg,transparent,rgba(200,0,255,0.2),rgba(255,215,0,0.15),transparent);animation:shine_swipe 1.8s ease-in-out infinite"></div>
        </div>
        ...
        overlay = f'''
        <!-- Nubi nere con fulmini -->
        <div style="position:absolute;top:4px;left:5px;font-size:0.9rem;opacity:0.6;animation:cloud_drift 3s ease-in-out infinite;pointer-events:none;filter:brightness(0.4) contrast(2)">⛈️</div>
        <div style="position:absolute;top:3px;right:5px;font-size:0.8rem;opacity:0.5;animation:cloud_drift 3.5s ease-in-out infinite 1s;pointer-events:none;filter:brightness(0.3) contrast(2)">⛈️</div>
        <!-- Fulmini animati -->
        <div style="position:absolute;top:22%;left:4px;font-size:0.8rem;animation:lightning 2.5s infinite;pointer-events:none;color:#FF4400;filter:drop-shadow(0 0 4px #FF4400)">⚡</div>
        <div style="position:absolute;top:38%;right:4px;font-size:0.7rem;animation:lightning2 2.5s infinite 0.8s;pointer-events:none;color:#FF2200;filter:drop-shadow(0 0 4px #FF2200)">⚡</div>
        <!-- Ali nere infuocate -->
        <div style="position:absolute;top:16%;left:-36px;width:44px;height:85px;pointer-events:none">
          <svg width="44" height="85" viewBox="0 0 44 85" style="animation:wing_float 2.8s ease-in-out infinite;filter:drop-shadow(0 0 10px rgba(255,50,0,0.9))">
        ...
        <div style="position:absolute;top:16%;right:-36px;width:44px;height:85px;pointer-events:none">
          <svg width="44" height="85" viewBox="0 0 44 85" style="animation:wing_float_r 2.8s ease-in-out infinite 0.3s;filter:drop-shadow(0 0 10px rgba(255,50,0,0.9))">
            <path d="M0,6 Q44,16 42,42 Q44,68 0,78 Q24,58 22,42 Q24,26 0,6Z" fill="rgba(30,0,0,0.95)" stroke="#FF2200" stroke-width="1.2"/>
          </svg>
        </div>
        <!-- Angolo sgretolato in alto a destra -->
        ...
        <!-- Bagliore infernale animato -->
        <div style="position:absolute;top:0;left:0;right:0;bottom:0;pointer-events:none;overflow:hidden;border-radius:14px">
          <div style="position:absolute;top:0;left:-120%;width:50%;height:100%;background:linear-gradient(105deg,transparent,rgba(255,60,0,0.2),transparent);animation:shine_swipe 2.2s ease-in-out infinite"></div>
        </div>
        '''
    ...
    return f"""
<div id="{cid}" style="position:relative;background:{card_bg};border:2px solid {border_col};
    {card_shape}
    ...
    transition:transform 0.25s ease,box-shadow 0.25s ease;{cursor}overflow:visible;
  ...
  <div style="position:relative;overflow:hidden;border-radius:12px 12px 0 0">
    ...
    <!-- OVR in alto a sinistra con glow pulsante -->
    <div style="position:absolute;top:6px;left:7px;text-align:center;line-height:1">
      <div style="font-size:{ovr_size};font-weight:900;color:{ovr_col};
          ...
          animation:ovr_pulse 2s ease-in-out infinite;line-height:1">{overall}</div>
      <div style="font-size:0.45rem;letter-spacing:2.5px;font-weight:800;opacity:0.85;text-shadow:none">OVR</div>
    </div>
    <!-- Label tipo in alto a destra -->
    <div style="position:absolute;top:6px;right:6px;background:{badge_bg};
        backdrop-filter:blur(6px);-webkit-backdrop-filter:blur(6px);border-radius:5px;padding:3px 6px">
  ...
  <!-- ATTRIBUTI -->
  <div style="background:rgba(0,0,0,0.22);padding:5px 0;margin-top:2px;backdrop-filter:blur(2px)">{attrs_html}</div>
  <!-- FOOTER STATS -->
  <div style="font-size:0.52rem;opacity:0.8;padding:5px 6px 0;display:flex;justify-content:space-around;letter-spacing:0.5px">
